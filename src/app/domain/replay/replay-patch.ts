 ...
 *
 * A removal takes its object away and a patch makes or changes one; events with neither are
 * passed over. The snapshot is copied first unless `shareInput` is set.
 */
