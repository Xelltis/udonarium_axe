 ...
 *
 * Events the viewer was not allowed to see never do. Hiding secrets drops everything that was not
 * public, an actor filter keeps only that user's events, and sound effects that merely go with
 * another event stay out unless asked for. Markers are shown whatever the scope; otherwise the chat
 * scope keeps chat and dice lines and the board scope keeps the rest.
 */
